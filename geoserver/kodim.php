...
<div class="container">
  <div class="row">
    <div class="col-sm-2">
      <h3>DKomando Distrik Militer</h3>
      <p>
      Kodim adalah komando militer di tingkat distrik yang memiliki tanggung jawab atas beberapa wilayah Koramil. Kodim berperan dalam merencanakan dan melaksanakan kegiatan militer di tingkat yang lebih luas.
    </div>
    <div class="col-sm-10">
  ...
  this._div.innerHTML = '<h4>PETA SEBARAN TITIK LOKASI KOMANDI DISTRIK MILITER<br>DI KABUPATEN SLEMAN TAHUN 2019</h4>'
