...
<head>
  ...
  <style>
    ...
    /* Add styles for the home page map */
    #map-container {
      display: flex;
    ...
    #map {
      ...
      width: 100vh; /* Set the width to match the height */
    }
    ...
    #map-text {
      ...
      width: 30%; /* Set the width to match the height */
    }
  ...
  text-align: justify;
    ...
    .inageoportal-button {
      ...
      position: absolute;
      top: 600px; /* Adjust the top value to position the button below the map */
      right: 470px; /* Adjust the right value to position the button on the right */
    }
...
<!-- Home Page Content with Leaflet Map, Text, and Image -->
<div id="map-container">
  <div id="map"></div>
  <div id="map-text">
  <h4><b>"SafeZoneSlemanGIS:  Persebaran Titik Strategis dalam Pertahanan dan Keamanan Wilayah Sleman"</b></h4>
  <img src="kemanan2.jpg" class="img-rounded" alt="Cinque Terre">
  <p>SlemanSecurityGIS adalah platform Geographical Information System (GIS) inovatif yang dipersembahkan untuk menggambarkan dan menganalisis aspek-aspek krusial dari pertahanan dan keamanan di Wilayah Sleman. Dengan fokus pada pemetaan strategis, SlemanSecurityGIS menyajikan informasi mendalam tentang infrastruktur pertahanan, pola keamanan, dan upaya-upaya pencegahan di seluruh wilayah.</p>
</div>
</div>

<!-- Button Redirecting to Traveloka -->
<a href="https://geoportal.slemankab.go.id/" class="inageoportal-button" target="_blank">Informasi Data</a>

<footer>
  <p>Created by: <a href="https://youtube.com/@faniaisyah4627?si=3HDFS4M-5KZJt4Pk" target="_blank">Fani Aisyah</a></p>
</footer>
...
<script>
        ...
        // Assuming 'map' is a valid Leaflet map instance created earlier
        
        /*Plugin Routing */
        L.Routing.control({
            waypoints: [
                L.latLng(-7.619626824869306, 110.42114365094166),
                L.latLng(-7.683725313099034, 110.36948938981459)
            ],
