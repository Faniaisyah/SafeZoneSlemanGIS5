...
<div class="jumbotron text-center">
  <h1>GIS Pertahanan dan Keamanan: Peta Sebaran Fasilitas Kabupaten Sleman Tahun 2019</h1>
...
<div class="container">
  <div class="row">
    <div class="col-sm-2">
      <h3>Definisi</h3>
      <p>
GIS Pertahanan dan Keamanan Kabupaten Sleman tahun 2019 memvisualisasikan sebaran fasilitas seperti Pos Polisi, Koramil, pangkalan militer, bunker perlindungan, dan lapas narkoba. Peta ini memberikan gambaran lokasi strategis fasilitas pertahanan dan keamanan, mendukung pemahaman spasial bagi pemangku kepentingan untuk perencanaan dan manajemen keamanan di wilayah tersebut.</p>
  ...
  this._div.innerHTML = '<h4>PETA SEBARAN FASILITAS PERTAHANAN DAN KEAMANAN<br>DI KABUPATEN SLEMAN TAHUN 2019</h4>'
      ...
      var wfsgeoserver1 = L.geoJson(null, {
        ...
        L.Control.Watermark = L.Control.extend({
            onAdd: function(map) {
                ...
                img.src = 'assets/img/LOGO_SIG_BLUE.png';
        ...
        L.Control.Legend = L.Control.extend({
            onAdd: function(map) {
                var img = L.DomUtil.create('img');
                img.src = 'assets/img/Legenda2.png';
