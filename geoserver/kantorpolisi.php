...
<div class="container">
  <div class="row">
    <div class="col-sm-2">
      <h3>Kantor Polisi</h3>
      <p>
      Kantor Polisi adalah markas operasional kepolisian di suatu wilayah. Fasilitas ini menjadi pusat untuk penyelidikan, patroli, dan pemberian pelayanan kepada masyarakat guna menjaga keamanan, ketertiban, dan penegakan hukum.
    </div>
    <div class="col-sm-10">
  ...
  this._div.innerHTML = '<h4>PETA SEBARAN TITIK LOKASI KANTOR POLISI<br>DI KABUPATEN SLEMAN TAHUN 2019</h4>'
