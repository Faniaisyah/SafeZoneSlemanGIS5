...
<div class="container">
  <div class="row">
    <div class="col-sm-2">
      ...
      <p>
      Pangkalan Militer adalah kompleks fasilitas yang digunakan oleh angkatan bersenjata untuk berbagai keperluan. Termasuk di dalamnya adalah tempat penyimpanan senjata, pelatihan militer, operasi logistik, serta pusat komando dan kontrol.
    </div>
    <div class="col-sm-10">
  ...
  this._div.innerHTML = '<h4>PETA SEBARAN TITIK LOKASI PANGKALAN MILITER<br>DI KABUPATEN SLEMAN TAHUN 2019</h4>'
        ...
        $sql = "SELECT * FROM pangkalan_militer";
