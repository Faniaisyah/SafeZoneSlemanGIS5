...
<div class="container">
  <div class="row">
    <div class="col-sm-2">
      <h3>Komando Rayon Militer</h3>
      <p>
      Koramil adalah unit militer di tingkat rayon yang bertanggung jawab atas administrasi, logistik, dan pengembangan wilayah tertentu. Koramil memiliki peran penting dalam mendukung kegiatan militer di tingkat lokal. 
    </div>
    <div class="col-sm-10">
  ...
  this._div.innerHTML = '<h4>PETA SEBARAN TITIK LOKASI KOMANDO LAYER MILITER<br>DI KABUPATEN SLEMAN TAHUN 2019</h4>'
